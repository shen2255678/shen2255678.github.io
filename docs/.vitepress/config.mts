  ...
  themeConfig: {
    ...
    nav: [
      ...
      { 
        text: '旅行', 
        items: [
          { text: '旅行總覽', link: '/travel/' },
          { text: '瑞士之旅', link: '/travel/switzerland' },
          { text: '日本之旅', link: '/travel/japan' },
          { text: '東京見聞', link: '/travel/tokyo' },
          { text: '歐洲漫遊', link: '/travel/europe' }
        ]
      },
      { 
        text: '關於', 
    ...
    blog:{
      ornateStyle: true, 
      title: "Haowei Blog",     //昵称
      desc: "經營自己的同時，紀錄生活上的點滴。人的一生中有兩個時期不應投機；無力投機時，以及有能力投機時",  //签名
      avatar:"https://i.pinimg.com/736x/5b/f6/a9/5bf6a9efe2bac9f12b42fa41fa78a979.jpg",             //你的头像(图片url)
      search: true,  // 啟用搜索功能
      pageSize: 10,  // 每頁顯示文章數量
      features: [
        {
          title: "AI技術",
    ...
    //     text: 'AI技術',
    //     items: [
    //       { text: 'MCP架構介紹', link: '/posts/ai/mcp-introduction' },
    //       { text: '企業級AI應用', link: '/posts/ai/enterprise-ai' }
    //     ]
    //   },
    //   {
    //     text: '程式開發',
    //     items: [
    //       { text: 'VitePress教程', link: '/coding/vitepress-tutorial' }
    //     ]
    //   }
    // ],
